...
const SCENARIOS_HELP_SECTIONS = [
  {
    ...
    body:
      "Сценарий собирает полный план исполнения текущей ревизии RFQ. На каждую строку заказа выбирается один сохранённый вариант исполнения из вкладки «Покрытие».",
  },
  {
  ...
  },
  {
    ...
    body:
      "Внизу в таблице «Сценарии RFQ» нажмите «Показать состав». Если заявка получила новую ревизию, старые сценарии остаются историей: сначала синхронизируйте RFQ и пересоберите покрытие/сценарий для нового состава.",
  },
]
