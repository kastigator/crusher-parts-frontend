...
const ECONOMICS_HELP_SECTIONS = [
  {
    ...
    body:
      "Экономика собирает сценарий текущей ревизии RFQ в денежный результат: товар, фрахт, пошлины и итоговую себестоимость по строкам и по сценарию целиком.",
  },
  {
    title: "Что здесь происходит",
    body:
      "Сначала на вкладке Сценарии выбирается вариант исполнения на каждую строку RFQ. Затем Логистика добавляет группы отгрузки. После этого Экономика считает итог. При новой ревизии заявки старую экономику нельзя использовать как актуальную базу.",
  },
  {
